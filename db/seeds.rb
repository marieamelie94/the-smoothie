...
beets_frozen = Ingredient.create!(name: "Beets", description: 'What\'s your favorite veg to blend?  Beetroots are super healthy for your blood and immune system. Due to chemical reactions, caused by nutrients in beets, your blood literally flows better. A bit high on sugar, something to keep in mind. Has around 45 calories per 100g, 10g of carbs and 1,3 of protein.', photo:"https://res.cloudinary.com/mas-cloud/image/upload/v1544030908/the-smoothie/beets.png")
cucumber_frozen = Ingredient.create!(name: "Cucumber", description: 'Cucumber is probably the most hydrating vegetable there is(over 90% water) Extremely low in calories, full of minerals and vitamins. Helps relief itchy and sunburns. ', photo: "https://res.cloudinary.com/mas-cloud/image/upload/v1544031814/the-smoothie/cucumbers.png")
